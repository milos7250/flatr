...
PASS_SITES = [
    ...
    (
        sites.Rightmove,
        "https://www.rightmove.co.uk/property-to-rent/find.html?searchLocation=Edinburgh&useLocationIdentifier=true&locationIdentifier=REGION%5E475&radius=0.0&_includeLetAgreed=on&includeLetAgreed=false",
    ),
    ...
    (sites.Domus, "https://domus.ed.ac.uk/properties/"),
]
...
FAIL_SITES = [
    (
        sites.Zoopla,
        "https://www.zoopla.co.uk/to-rent/property/edinburgh-county/?price_frequency=per_month&q=Edinburgh&search_source=home",
    )
]
